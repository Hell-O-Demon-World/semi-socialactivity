    ...
    <div class="container">
      ...
      <div class="form-box">
        <div class="form sign-in-form">
          <form action="/login.do" method="get" class="sign-in-form-list">
            <h3>Sign In<p id = "signinMsg"></p></h3>
            <input
                  id="signinId"
                  type="text"
                  placeholder="userID"
        ...
        <div class="form sign-up-form">
          <form action="sign-up.do" method="get" class="sign-up-form-list">
            <h3 class="sign-up-h3">Sign Up<p id = "signupMsg"></p></h3>
            <input
                  id="userName"
                  type="text"
                  name="userName"
            ...
            <input
                  ...
                  type="text"
                  name="userID"
                  placeholder="user ID(11자리)"
                  maxlength="11"
                  oninput="numberMaxLength(this)"
                  onfocus = "signupIdCheck(this)"
            />
            <input
                  id="signupPd"
                  type="password"
